...
| ~~P1~~ | ~~H-1~~ | ~~添加 ServerEndpointExporter Bean~~ | **FIXED** |
| ~~P1~~ | ~~H-2~~ | ~~统一 @TableLogic 策略~~ | **FIXED** |
| ~~P1~~ | ~~H-3~~ | ~~修复 DataScopeInterceptor SQL 逻辑~~ | **FIXED** |
| **P2** | M-1 | 积分系统未实现 | 待修复（需团队讨论） |
| ~~P2~~ | ~~M-2~~ | ~~@Transactional 添加 rollbackFor~~ | **FIXED** |
| **P2** | M-3 | Service 方法返回 Object 类型 | 待修复（需团队讨论） |
| **P2** | M-4 | LoginLogMapper / OperateLogMapper 孤立 | 待修复 |
| ~~P2~~ | ~~F-1~F-4~~ | ~~前端类型定义补全~~ | **FIXED** |
...
| `.gitignore` | 新增 | C-2 |
| `message-service/.../config/WebSocketConfig.java` | 新增 | H-1 |
| `oceanverse-pojo/.../entity/Species.java` | 修改 | H-2 |
| `oceanverse-pojo/.../entity/Observation.java` | 修改 | H-2 |
| `oceanverse-pojo/.../entity/SpeciesDistribution.java` | 修改 | H-2 |
| `oceanverse-pojo/.../entity/SpeciesMedia.java` | 修改 | H-2 |
| `oceanverse-pojo/.../entity/Ecosystem.java` | 修改 | H-2 |
| `oceanverse-pojo/.../entity/ObservationLocation.java` | 修改 | H-2 |
| `user-auth-manager/.../interceptor/DataScopeInterceptor.java` | 修改 | H-3 |
| `community-manager/.../service/impl/CommunityServiceImpl.java` | 修改 | M-2 |
| `OceanVerse-frontend/src/types/index.ts` | 修改 | F-1, F-3 |
| `OceanVerse-frontend/src/stores/user.ts` | 修改 | F-2 |
